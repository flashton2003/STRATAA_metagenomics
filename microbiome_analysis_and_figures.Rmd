...
give.n <- function(x){
  return(c(y = 45, label = length(x)))
}
plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__Prevotella_copri_clade_A', 'Malawi', c('Acute_Typhi', 'Control_HealthySerosurvey'))

give.n <- function(x){
  return(c(y = 6, label = length(x)))
}
plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__Prevotella_copri_clade_A', 'Bangladesh', c('Acute_Typhi', 'Control_HealthySerosurvey'))


give.n <- function(x){
  return(c(y = 0.5, label = length(x)))
}
plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__Clostridium_SGB6179', 'Malawi', c('Acute_Typhi', 'Control_HealthySerosurvey'))

give.n <- function(x){
  return(c(y = 4.5, label = length(x)))
}
plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__Clostridium_SGB6179', 'Bangladesh', c('Acute_Typhi', 'Control_HealthySerosurvey'))

give.n <- function(x){
  return(c(y = 5, label = length(x)))
}
plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__GGB4266_SGB5809', 'Malawi', c('Acute_Typhi', 'Control_HealthySerosurvey'))
give.n <- function(x){
  return(c(y = 10, label = length(x)))
}
plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__GGB4266_SGB5809', 'Bangladesh', c('Acute_Typhi', 'Control_HealthySerosurvey'))

give.n <- function(x){
  return(c(y = 2.5, label = length(x)))
}
plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__Haemophilus_parainfluenzae', 'Malawi', c('Acute_Typhi', 'Control_HealthySerosurvey'))

give.n <- function(x){
  return(c(y = 1.25, label = length(x)))
}
plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__Haemophilus_parainfluenzae', 'Bangladesh', c('Acute_Typhi', 'Control_HealthySerosurvey'))


give.n <- function(x){
  return(c(y = 1.5, label = length(x)))
}
plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__Romboutsia_timonensis', 'Malawi', c('Acute_Typhi', 'Control_HealthySerosurvey'))


give.n <- function(x){
  return(c(y = 6, label = length(x)))
}
plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__Romboutsia_timonensis', 'Bangladesh', c('Acute_Typhi', 'Control_HealthySerosurvey'))
...
plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__Lachnospiraceae_bacterium', 'Malawi', c('Acute_Typhi', 'Control_HealthySerosurvey'))

give.n <- function(x){
  return(c(y = 1.75, label = length(x)))
}

plot_species_of_interest(strataa_metaphlan_data_longer_meta, 's__Lachnospiraceae_bacterium', 'Bangladesh', c('Acute_Typhi', 'Control_HealthySerosurvey'))
