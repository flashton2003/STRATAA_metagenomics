...
```{r combine_maaslins_for_strataa_and_patch}
...
```{r species_of_interest_prevalence}

groups_to_analyse <- c('Acute typhoid', 'Control')
prevalence <- get_species_of_interest_prevalence(strataa_metaphlan_data_species, groups_to_analyse)

```

```{r per_species_data_for_forest_plot}


run_forest_plot(prevalence, 's__Prevotella_copri_clade_A', combined_maaslins)
's__GGB4266_SGB5809'
...
pcopri_maaslins_results <- get_maaslin_results_for_species(combined_maaslins, '_Prevotella_copri_clade_A')
s__GGB4266_SGB5809_maaslins_results <- get_maaslin_results_for_species(combined_maaslins, 's__GGB4266_SGB5809')
hpara_maaslins_results <- get_maaslin_results_for_species(combined_maaslins, 's__Haemophilus_parainfluenzae')
...
```{r forest_plot2}
run_forest_plot(prevalence, 's__Prevotella_copri_clade_A', pcopri_maaslins_results)
run_forest_plot(prevalence, , s__GGB4266_SGB5809_maaslins_results)
run_forest_plot(prevalence, , hpara_maaslins_results)
