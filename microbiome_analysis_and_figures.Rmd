...
dge_output$sig_up_cases_controls %>% select(species, all_sites_logFC, all_sites_FDR, bangladesh_logFC, bangladesh_FDR, malawi_logFC, malawi_FDR) %>% kbl() %>% kable_styling()
