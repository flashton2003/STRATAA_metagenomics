...
mal_func_maaslin <- read_in_maaslin('Malawi', groups_to_analyse, bang_variables_for_analysis, 'bigmap')
```

```{r maaslin_functional_groups}

combined_maaslins <- combine_maaslins(bang_func_maaslin, mal_func_maaslin)
