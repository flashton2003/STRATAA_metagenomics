...
the_date <- '2022.11.10'
dge_output <- combine_and_compare_dges(to_combine, covar_initials, output_folder_all_three, output_folder_blantyre, output_folder_dhaka, output_folder_kathmandu, combined_output_root, the_date, comp)
#options(scipen = 999)
