...
View(head(strataa_disease_health_bigmap_data_l))
...
variables_for_analysis <- c("Group", "Sex", "Age", "Antibiotics_taken_before_sampling_assumptions")
run_maaslin(strataa_disease_health_bigmap_mgc, strataa_bigmap_metadata, maaslin_functional_output_root_folder, 'Nepal', groups_to_analyse, variables_for_analysis, 'NONE', 'LOG', NA, 'bigmap')
