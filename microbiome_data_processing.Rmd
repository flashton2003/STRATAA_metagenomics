...
metaphlan_input_date <- "2023.05.03"
```
...
strataa_metaphlan_data = read.csv(file = file.path(metaphlan_input_folder, paste(metaphlan_input_date, 'strataa.metaphlan.merged.csv', sep = '.')), header= TRUE, sep = ",", row.names = 1, stringsAsFactors = FALSE, check.names=FALSE)
strataa_metaphlan_metadata = read.csv(file = file.path(metaphlan_input_folder, paste(metaphlan_input_date, 'strataa_metadata.metaphlan.csv', sep = '.')), header = TRUE, sep = ",", row.names = 1, stringsAsFactors = FALSE)
...
#bgd_acute_healthy_output_dir <- file.path(maaslin_output_root_folder, paste())

run_maaslin(strataa_metaphlan_data, strataa_metaphlan_metadata, maaslin_output_root_folder, 'Bangladesh', groups_to_analyse, variables_for_analysis, 'NONE', 'LOG')
run_maaslin(strataa_metaphlan_data, strataa_metaphlan_metadata, maaslin_output_root_folder, 'Malawi', groups_to_analyse, variables_for_analysis, 'NONE', 'LOG')
```
