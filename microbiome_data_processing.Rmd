...
run_calculate_dge <- function(meta, output_folder, tax_level, countries_to_include){
  ...
  calculate_dge(meta_subset, output_folder, tax_level, filtered_otu.unnormalised)

}


run_calculate_dge(metadata, output_folder_blantyre, taxonomic_level, just_malawi)
```
