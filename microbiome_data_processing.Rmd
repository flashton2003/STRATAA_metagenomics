...
rownames(metadata) <- metadata$Lane
strataa_metaphlan_metadata <- metadata %>% dplyr::select(Lane, Group, Sex, Country, Age, Antibiotics_taken_before_sampling_assumptions, sequencing_lane)
