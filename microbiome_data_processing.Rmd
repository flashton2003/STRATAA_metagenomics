...
* need to do some basic stats on number of reads per sample
* should do alpha diversity on normalised or unnormalised read numbers?
...
run_calculate_alpha <- function(output_folder, tax_level, countries, fn_regex, braken_folder, meta){
  ...
  calculate_alpha(filtered_otu.unnormalised, meta, quote("Group"), output_folder, "Phenotype")  
}

# all_three_countries won't be needed if the beta diversity has already been calculated, but should include just in case.
run_calculate_alpha(output_folder_blantyre, taxonomic_level, all_three_countries, filename_regex, braken_folder, metadata)
