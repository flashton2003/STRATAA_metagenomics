...
amr_summarised_typhi_d_meta_abu <- left_join(amr_summarised_typhi_d, select(metadata, c(Lane, Country, Group, Antibiotics_taken_before_sampling)), by = join_by(sample == Lane)) %>% filter(!(Antibiotics_taken_before_sampling == 'no')) %>% filter(!(is.na(Antibiotics_taken_before_sampling))) %>% filter(!(Antibiotics_taken_before_sampling == '#N/A')) %>% filter(!(Antibiotics_taken_before_sampling == '')) %>% filter(!(Antibiotics_taken_before_sampling == 'Unknown')) %>% mutate(Antibiotics_taken_before_sampling = ifelse(Antibiotics_taken_before_sampling == 'yes', 'Yes', Antibiotics_taken_before_sampling))
amr_summarised_typhi_d_meta_abu <- amr_summarised_typhi_d_meta_abu %>% filter(Country == 'Bangladesh')
amr_summarised_typhi_d_meta_abu <- amr_summarised_typhi_d_meta_abu %>% mutate(Azithromyin)

View(amr_summarised_typhi_d_meta_abu)
